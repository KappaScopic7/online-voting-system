...
@Entity @Table(name = "party", uniqueConstraints = {
...
public class Party {
    ...
    @ElementCollection @CollectionTable(name = "party_ideology_tag", joinColumns = @JoinColumn(name = "party_id")) @Column(name = "tag", nullable = false, length = 100)
