...
import com.bteam.ovs.auth.api.dto.TokenResponse;
import com.bteam.ovs.auth.api.dto.VoterLoginRequest;
import com.bteam.ovs.auth.api.dto.VoterRegisterRequest;
import com.bteam.ovs.auth.domain.Role;
import com.bteam.ovs.auth.infra.jpa.PortalAccountEntity;
...
public class VoterAuthService {
    ...
    public VoterAuthService(PortalAccountJpaRepository portalRepo, PasswordEncoder passwordEncoder, JwtService jwtService) {
    ...
    public void register(VoterRegisterRequest req) {
        ...
        // TODO(UC_02): 認証メール送信（token発行→メール→verify API）
    }
